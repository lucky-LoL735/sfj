...
export default {
  setup () {
    const drawEchart = function (dom, option) {
    ...
    const drawEchartLine = function () {
      ...
      drawEchart('div.line', option)
    }
    const drawEchartStackLine = function () {
      const option = {
        tooltip: {
          trigger: 'axis'
        },
      ...
      drawEchart('div.stack-line', option)
    }
